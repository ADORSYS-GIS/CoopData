              ...
              <div className="flex items-center gap-2">
                ...
                {financialSection && financialSection.status !== "ready" && (
                  <button
                    ...
                    disabled={updateSection.isPending || hasErrors || isExtracting}
                    ...
                    title={isExtracting ? t("financialStatementEditor.matrix.extractingHint") : hasErrors ? t("financialStatementEditor.matrix.resolveErrorsHint") : ""}
                  >
