...
export const FederationSocialImpactSheet: React.FC<FederationSocialImpactSheetProps> = ({
  ...
  return (
    <div className="print-page w-full h-[1122px] flex flex-col bg-white p-12 text-slate-900" style={{ pageBreakAfter: "always", pageBreakInside: "avoid" }}>
      <div className="flex justify-between items-end border-b-2 border-slate-900 pb-2 mb-6 shrink-0">
        ...
        <div className="text-right">
          ...
          <p className="text-sm text-slate-500">Sheet 6</p>
        </div>
      </div>
