...
const KEYS = ["maintained_pct", "minimum_pct", "gap_pct"];
...
export function LiquidityChart({ points }: { points: SeriesPoint[] | undefined }) {
  const text = useChartText("liquidity");
