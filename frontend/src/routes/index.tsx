  ...
  head: () => ({
    meta: [
      { title: "CoopData — National Cooperative Intelligence Platform" },
      {
        name: "description",
        content:
          "The centralized national system for cooperative registration, data, compliance and analytics — built for ministries, federations and cooperatives.",
      },
      { property: "og:title", content: "CoopData — National Cooperative Intelligence Platform" },
      {
        property: "og:description",
        content: "Trusted, transparent, government-grade cooperative data infrastructure.",
      },
    ],
  }),
