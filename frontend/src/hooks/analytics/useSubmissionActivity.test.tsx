...
import { useSubmissionActivity } from "./useSubmissionActivity";
...
describe("useSubmissionActivity", () => {
  beforeEach(() => {
    vi.clearAllMocks();
  });
  ...
  it("fetches data successfully", async () => {
    ...
    const { result } = renderHook(() => useSubmissionActivity(2025), { wrapper: createWrapper() });
